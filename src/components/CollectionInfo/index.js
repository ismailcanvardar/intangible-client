...
function CollectionInfo({ data }) {
  ...
  return (
    <Link
      ...
      className={`w-full md:w-72 h-96 rounded-xl bg-control shadow-gif flex flex-col transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-105 cursor-pointer`}
    >
      {collectionData &&
      ...
      <div className="rounded-b-xl px-6 py-4 bg-background">
